...
D'autres guides suivront, par capacité : envoi de cartes illustrées, envoi de photos, recommandé électronique eIDAS, publipostage, réception des webhooks de suivi. En attendant, ces capacités sont documentées dans le [README principal](../README.md) et dans la spec OpenAPI.
